...
class ChatPDF:
	...
	def __init__(self):
			...
			self.prompt = PromptTemplate.from_template(
					"""
					<s> [INST] use the context to be more specific . If you don't know the answer, just say that you don't know. Use three sentences
	...
	def ingests(self, pdf_paths: set[str]):
		vector_store_chunks =  []
		i = 0
